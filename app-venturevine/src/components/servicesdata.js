...
export default(
    [
        ...
        {
            servicename: "Legal Support",
            image:"../images/legal.jpg",
            description: "Get access to experienced legal professionals who specialize in startup law, offering expert guidance and advice on various legal matters." ,
        },
        {
